...
module md_hamiltonian
    ...
    subroutine sb_gen_ham()
        ...
        call sb_gen_ht(n_num_site, n_basis_up, n_basis_dn, n_num_basis_up, n_num_basis_dn, n_ht_up, n_ht_dn, &
    ...
    subroutine sb_init_ham()
        allocate(n_hu(n_num_basis))
        allocate(n_ht_dn(n_num_basis_dn, n_num_site))
        allocate(n_ht_up(n_num_basis_up, n_num_site))
        allocate(n_ht_pbc_dn(n_num_basis_dn))
        allocate(n_ht_pbc_up(n_num_basis_up))
    ...
    !>generate Hu part of the Hamiltonian
    subroutine sb_gen_hu()
        implicit none
        ! code
    ...
    !>generate Hu part of the Hamiltonian of 1D Hubbard Model
